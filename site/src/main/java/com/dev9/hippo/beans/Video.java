...
@HippoEssentialsGenerated(internalName = "gamedayproject:video")
@Node(jcrType = "gamedayproject:video")
public class Video extends BaseDocument {
    ...
    public String getDescription() {
        return getProperty("gamedayproject:description");
    }

    @HippoEssentialsGenerated(internalName = "gamedayproject:link")
    public String getLink() {
        return getProperty("gamedayproject:link");
    }
}

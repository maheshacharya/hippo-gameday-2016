...
function Calendar(props) {
    ...
    $(document).ready(function () {
        if (props === undefined) {
            props = {
                ...
                'date_field_class': 'event-calendar' };
        }

        //class name of input field that is will invoke the calendar display.
    ...
    function buildNavigation(table, date) {
        ...
        $(tr).append('<td colspan =\'7\' style=\'text-align:center;padding-bottom:10px;background-color:rgba(0,0,0,0.02);height:' + h + 'px;\'>' + '<span style=\'display:inline;\' class=\'year-control calendar-control\' ' + 'name=\'calendar-control\' title=\'Previous Year\'>&#171;</span>' + '<span style=\'display:inline;\' class=\'month-control calendar-control\' ' + 'name=\'calendar-control\' title=\'Previous Month\'>&lsaquo;</span>' + '<span><select class=\'calendar-month-selector\'' + ' name=\'calendar-control\' style=\'display:inline;height:' + h + 'px;font-size:' + h / 2 + 'px;border:none;background-color:rgba(0,0,0,0.0)\'></select></span>' + '<span><select class=\'calendar-year-selector\' ' + 'name=\'calendar-control\' style=\'display:inline;height:' + h + 'px;font-size:' + h / 2 + 'px;border:none;background-color:rgba(0,0,0,0.0)\'></select></span>' + '<span style=\'display:inline;\' class=\'month-control calendar-control\' ' + 'name=\'calendar-control\' title=\'Next Month\'>&rsaquo;</span>' + '<span style=\'display:inline;\' class=\'year-control calendar-control\' ' + 'name=\'calendar-control\' title=\'Next Year\'> &#187;</span>' + '</td>');
...
function DateFormat(formatString, date) {
    ...
    if (parseInt(MONTH) < 10 && MONTH.toString().length < 2) strMONTH = '0' + MONTH;else strMONTH = MONTH;
    if (parseInt(DAY) < 10 && DAY.toString().length < 2) strDAY = '0' + DAY;else strDAY = DAY;
    ...
    $.ajax({
        ...
        if (data.code === 200) {
            ...
            $(data.data.eventInfo).each(function (i, event) {
                ...
                $(el).append('<div class=\'event-details\' ' + 'style=\'display:none;padding:10px;position:absolute;background:rgba(250,216,22,.9);z-index:99999;border:1px solid #333\'>' + '<div>' + event.startTime + '</div>' + '<div style=\'font-weight:bold\'><a href=\'' + eventlink + '\'>' + event.title + '</a></div>' + '</div>');
            });
        }
    });
}
//# sourceMappingURL=macharya-calendar.js.map
